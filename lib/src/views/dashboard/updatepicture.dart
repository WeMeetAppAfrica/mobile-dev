...
class UpdatePhotos extends StatefulWidget {
  final kyc;
  final token;
  UpdatePhotos({Key key, this.kyc, this.token}) : super(key: key);
                        ...
                        child: _picture0 == null
                            ? widget.kyc.profileImage == null
                                ...
                                : Container(
                                    ...
                                    child: Image(
                                      image:
                                          NetworkImage(widget.kyc.profileImage),
                                      fit: BoxFit.cover,
                                    ),
                                    decoration: new BoxDecoration(
                                      color: Color.fromARGB(255, 247, 247, 247),
                            ...
                            : StreamBuilder(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return widget.kyc.profileImage == null
                                      ? Container(
                                          height: 120.0,
                                          width: 120,
                                          child: Icon(Icons.photo_camera),
                              ...
                              child: _picture1 == null
                                  ...
                                  : StreamBuilder(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.hasData) {
                                          switch (snapshot.data.status) {
                                            case Status.ADDIMAGEUPDATE1LOADING:
                                              return Stack(
                                                children: [
                                                  Container(
                                                    height: 120.0,
                                              ...
                                              break;
                                            case Status.ADDIMAGEUPDATE1DONE:
                                              addImage1 = snapshot
                              ...
                              child: _picture2 == null
                                  ...
                                  : StreamBuilder(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.hasData) {
                                          switch (snapshot.data.status) {
                                            case Status.ADDIMAGEUPDATE2LOADING:
                                              return Stack(
                                                children: [
                                                  Container(
                                                    height: 120.0,
                                              ...
                                              break;
                                            case Status.ADDIMAGEUPDATE2DONE:
                                              addImage2 = snapshot
                                                  .data.data.data.imageUrl;
                                              print(addImage1);
                                              return Container(
                              ...
                              child: _picture3 == null
                                  ...
                                  : StreamBuilder(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.hasData) {
                                          switch (snapshot.data.status) {
                                            case Status.ADDIMAGEUPDATE3LOADING:
                                              return Stack(
                                                children: [
                                                  Container(
                                                    height: 120.0,
                                              ...
                                              break;
                                            case Status.ADDIMAGEUPDATE3DONE:
                                              addImage3 = snapshot
                                                  .data.data.data.imageUrl;
                                              print(addImage3);
                                              return Container(
                              ...
                              child: _picture4 == null
                                  ...
                                  : StreamBuilder(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.hasData) {
                                          switch (snapshot.data.status) {
                                            case Status.ADDIMAGEUPDATE4LOADING:
                                              return Stack(
                                                children: [
                                                  Container(
                                                    height: 120.0,
                                              ...
                                              break;
                                            case Status.ADDIMAGEUPDATE4DONE:
                                              addImage4 = snapshot
                                                  .data.data.data.imageUrl;
                                              print(addImage4);
                                              return Container(
                              ...
                              child: _picture5 == null
                                  ...
                                  : StreamBuilder(
                                      ...
                                      builder: (context, snapshot) {
                                        if (snapshot.hasData) {
                                          switch (snapshot.data.status) {
                                            case Status.ADDIMAGEUPDATE5LOADING:
                                              return Stack(
                                                children: [
                                                  Container(
                                                    height: 120.0,
                                              ...
                                              break;
                                            case Status.ADDIMAGEUPDATE5DONE:
                                              addImage5 = snapshot
                                                  .data.data.data.imageUrl;
                                              print(addImage5);
                                              return Container(
